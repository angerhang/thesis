...
In this project, we successfully applied
 ...
 the  people's Motor Learning Skills (MLS), \nomenclature{\textbf{MLS}}{ Motor Learning Skills} given the resting state EEG recording, and confirm that hypothesis \todo{need to fill in after discussion}
...
\todo{OK to use abberviation in abstract?}
