...
% Author
{\noindent \large \textsf{Hang Yuan, Claudia Voelcker-Rehage, Lena H\"ubner, Benjamin Godde }} \\
\\
...
\noindent
{\bf Hang Yuan, Claudia Voelcker-Rehage, Lena Hübner, Benjamin Godde  }\\
\\
{\it 
...
\begin{itemize}
	...
	\item Non-stationarity: EEG signals from the same subject can change as gel on the recording electrodes dry up, the subject has a different mental state or even the dislocation of the electrodes in a different trials/sessions.
